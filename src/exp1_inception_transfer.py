...
def main(data_dir, output_dir, learning_rate):
    ...
    # Freeze the parameters of the pre-trained Inception model
    for param in inception.parameters():
        param.requires_grad = False

    # Modify the classifier (add custom output layer)
    num_features = inception.fc.in_features
    custom_output_layer = torch.nn.Linear(num_features, len(testid_classes))
    inception.fc = custom_output_layer
    ...
    optimizer = torch.optim.Adam(custom_output_layer.parameters(), lr=learning_rate) 
