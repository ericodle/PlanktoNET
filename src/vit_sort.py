...
'''
This script uses a pretrained ViT model to classify images from a specified directory, organizing them into subfolders within an output directory based on predicted classes. It ensures robust image handling, GPU utilization if available, and generates a confidence distribution plot of predictions.
'''
