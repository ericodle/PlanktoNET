...
class EvaluationWindow(QMainWindow):
    ...
    def selectModelPath(self):
        self.model_path, _ = QFileDialog.getOpenFileName(self, "Select Model File", filter="Model files (*.bin)")
...
class ExistingModelWindow(QMainWindow):
    ...
    def selectModelFile(self):
        ...
        model_file, _ = QFileDialog.getOpenFileName(self, "Select Model File", filter="Model files (*.bin)")
        if model_file:
